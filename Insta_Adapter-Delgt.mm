...
- (void)announceObjectDisplayWithAdapter:
(IGListAdapter *)listAdapter object:(id)object index:(NSInteger)index 
{
    IGAssertMainThread();
...
- (void)announceCellDisplayWithAdapter:(IGListAdapter *)listAdapter object:(id)
  object cell:(UICollectionViewCell *)cell indexPath:(NSIndexPath *)indexPath 
{
    IGAssertMainThread();
    for (id<IGListAdapterDelegate> delegate in [_delegates allObjects]) 
    {
...
- (void)announceCellEndDisplayWithAdapter:(IGListAdapter *)listAdapter object:(id)
  object cell:(UICollectionViewCell *)cell indexPath:(NSIndexPath *)indexPath {
    IGAssertMainThread();
    for (id<IGListAdapterDelegate> delegate in [_delegates allObjects]) 
    {
